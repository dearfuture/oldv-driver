...
SymbolResolver::SymbolResolver()
    : m_DbgHelp(std::experimental::make_unique_resource(::LoadLibrary(TEXT("DbgHelp.dll")), &::FreeLibrary))
    ...
    , m_Process(std::experimental::make_unique_resource(::GetCurrentProcess(), static_cast<SymCleanupType>(m_SymCleanup)))
{
// Delete these macros
