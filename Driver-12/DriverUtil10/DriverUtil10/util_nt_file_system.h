...
namespace ddk
{
	...
	{
	public:
		static bool get_file_full_path(PUNICODE_STRING inPath, PUNICODE_STRING outPath)
		{
		...
		static bool get_file_object_full_path(PFILE_OBJECT fileobject, PUNICODE_STRING usFullPath)
		{
